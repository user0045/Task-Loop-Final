    ...
    const fetchUserData = async () => {
      ...
      try {
        ...
        if (profile) {
          ...
          // We'll use only the user_ratings table for rating data 
          // to prevent duplication of counts
          setUserProfile(userProfileData);
        }
        ...
        if (ratingsError) {
          ...
          // Create default empty ratings if not found
          setUserRatings({
            creator_rating: 0,
            doer_rating: 0,
          ...
          console.log("Fetched user ratings:", ratingsData);
                        ...
                        <div className="flex items-center justify-center">
                          ...
                          {userRatings && userRatings.rating_count_creator > 0 && (
                            <Badge variant="outline" className="ml-1 h-5 text-xs">
                              {userRatings.rating_count_creator}
                            </Badge>
                          )}
                        </div>
                      </div>
