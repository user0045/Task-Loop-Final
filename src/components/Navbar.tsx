  ...
  return (
    <nav className="border-b bg-background sticky top-0 z-50">
      <div className="container mx-auto px-4 py-3 flex items-center">
        <Link to={isAuthenticated ? "/home" : "/"} className="flex items-center space-x-2 mr-6">
          <img src="/logo .png" alt="TaskLoop Logo" className="h-8 w-auto" />
          <span className="text-xl font-bold">Task Loop</span>
        </Link>
