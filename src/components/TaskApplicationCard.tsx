...
interface TaskApplicationCardProps {
  ...
  onApplicationsUpdated: () => void; // Added callback
}

const TaskApplicationCard = ({ application, onApprove, onReject, onApplicationsUpdated }: TaskApplicationCardProps) => {
  ...
  const handleApprove = () => {
    ...
    onApplicationsUpdated(); // Call after successful approval
    setIsProcessing(false);
  };
  ...
  const handleReject = async () => {
    ...
    try {
      ...
      if (success) {
        ...
        onApplicationsUpdated(); // Call after successful rejection
      }
    } catch (error) {
